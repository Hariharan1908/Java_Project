...
public class RailwayTicketReservationSystem {
    ...
    private int trainDeclaration = 1;
...
//    private ArrayList<Passenger> trainDeclaration = new ArrayList<>();
    ...
    public void bookTicket() {
        ...
        System.out.println("trainDeclaration ID: 589400");
        String TrainDeclaration = scanner.nextLine().toLowerCase();

//if condition

        /*if condition into train booking
                available seats = berth, middle, upper*/
...
//        if (age>70){
//            System.out.println("The man has older than you Bluddy");
//            return;
//        }
